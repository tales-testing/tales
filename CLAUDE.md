...
User-facing docs now live in [website/src/content/docs/docs/](website/src/content/docs/docs/) (Astro + Starlight, published at https://hyperxlab.github.io/tales/). The legacy `docs/` folder has been removed.
