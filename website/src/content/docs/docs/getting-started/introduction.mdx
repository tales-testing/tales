...
<LinkCard title="Install Tales" href="/docs/getting-started/installation/" description="Pick up a pre-built binary or build from source." />
<LinkCard title="Your first scenario" href="/docs/getting-started/first-scenario/" description="Write, validate and run a complete scenario in five minutes." />
<LinkCard title="CLI essentials" href="/docs/getting-started/cli-essentials/" description="Every command, every flag, every exit code." />
<LinkCard title="DSL overview" href="/docs/writing-scenarios/dsl-overview/" description="Top-level blocks, steps, source order, and the execution model." />
