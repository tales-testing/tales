...
func (d *recordingDriver) Tap(_ context.Context, _ string, _ driver.Locator, _, _ float64) error {
	d.tappedAtLeastOne.Add(1)

	return d.tapErr
}

func (d *recordingDriver) InputText(_ context.Context, _ string, _ driver.Locator, _ string, _ bool) error {
