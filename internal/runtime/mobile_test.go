...
func (s *stubMobileDriver) Tap(_ context.Context, _ string, _ driver.Locator, _, _ float64) error {
	s.taps.Add(1)

	return nil
}
func (s *stubMobileDriver) InputText(_ context.Context, _ string, _ driver.Locator, t string, _ bool) error {
